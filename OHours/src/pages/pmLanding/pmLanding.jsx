...
export default function PMLanding() {
  ...
  <Button onClick={handleCreateSession} className="px-6 py-3 text-lg bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300">
    Create New Session
  </Button>
  ...
  <div className="flex items-center space-x-4">
    ...
    />
    <Button onClick={handleJoinSession} className="px-6 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300">
      Join Session
    </Button>
  </div>
